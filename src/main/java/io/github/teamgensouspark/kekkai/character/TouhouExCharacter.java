...
public class TouhouExCharacter {
        // th155
        public static final TouhouCharacter SHION_YORIGAMI = TouhouCharacter.getOrCreate("SHION_YORIGAMI", "shion",
                        TouhouSpecies.GOD);
        public static final TouhouCharacter JYOON_YORIGAMI = TouhouCharacter.getOrCreate("JYOON_YORIGAMI", "jyoon",
                        TouhouSpecies.GOD);
        ...
        public static final TouhouCharacter NARUMI_YATADERA = TouhouCharacter.getOrCreate("NARUMI_YATADERA", "narumi",
                        TouhouSpecies.YOUKAI_MAGICIAN);
        public static final TouhouCharacter SATONO_NISHIDA = TouhouCharacter.getOrCreate("SATONO_NISHIDA", "satono",
                        TouhouSpecies.HUMAN);
        public static final TouhouCharacter MAI_TEIREIDA = TouhouCharacter.getOrCreate("MAI_TEIREIDA", "mai",
                        TouhouSpecies.HUMAN);
        public static final TouhouCharacter OKINA_MATARA = TouhouCharacter.getOrCreate("OKINA_MATARA", "okina",
                        TouhouSpecies.GOD);
        // th17
        public static final TouhouCharacter EIKA_EBISU = TouhouCharacter.getOrCreate("EIKA_EBISU", "eika",
                        TouhouSpecies.GOD);
        public static final TouhouCharacter URUMI_USHIZAKAI = TouhouCharacter.getOrCreate("URUMI_USHIZAKAI", "urumi",
                        TouhouSpecies.YOUKAI_KASHA);
        ...
        public static final TouhouCharacter KEIKI_HANIYASUSHIN = TouhouCharacter.getOrCreate("KEIKI_HANIYASUSHIN",
                        "keiki",
                        TouhouSpecies.GOD);
        public static final TouhouCharacter SAKI_KUROKOMA = TouhouCharacter.getOrCreate("SAKI_KUROKOMA", "saki",
                        TouhouExSpecies.YOUKAI_KUROKOMA);
        // th175
        public static final TouhouCharacter YUMA_TOUTETSU = TouhouCharacter.getOrCreate("YUMA_TOUTETSU", "yuma",
                        TouhouExSpecies.TAOTIE);
        // th18
        public static final TouhouCharacter MIKE_GOUTOKUZI = TouhouCharacter.getOrCreate("MIKE_GOUTOKUZI", "mike",
                        TouhouSpecies.YOUKAI_BEAST_CAT);
        ...
        public static final TouhouCharacter TSUKASA_KUDAMAKI = TouhouCharacter.getOrCreate("TSUKASA_KUDAMAKI",
                        "tsukasa",
                        TouhouSpecies.YOUKAI_BEAST_FOX);
        public static final TouhouCharacter MEGUMU_IIZUNAMARU = TouhouCharacter.getOrCreate("MEGUMU_IIZUNAMARU",
                        "megumu",
                        TouhouSpecies.YOUKAI_TENGU_CROW);
        public static final TouhouCharacter CHIMATA_TENKYU = TouhouCharacter.getOrCreate("CHIMATA_TENKYU", "chimata",
                        TouhouSpecies.GOD);
